...
contract TestTMMarket is Test {
    ...
    uint256 immutable defaultProtocolFeeShare = 0.2e6; // 20%
    uint256 immutable defaultFee = 0.01e6; // 1%
    uint256 immutable sqrtPrice0 = _sqrtX96(0.000_000_028e18); // 2.8e-8
    uint256 immutable sqrtPrice1 = _sqrtX96(0.000_000_38e18); // 3.8e-7
    uint256 immutable amount0A = 800_000_000e18; // 800e6
    uint256 immutable amount0B = 200_000_000e18; // 200e6
